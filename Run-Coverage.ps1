...
.\packages\OpenCover.4.6.519\tools\OpenCover.Console.exe -register:user -target:"packages\xunit.runner.console.2.1.0\tools\xunit.console.exe" -targetargs:"CoverageInvestigation.Test\bin\Debug\CoverageInvestigation.Test.dll" -output:"nocoverage.xml" -searchdirs:".\CoverageInvestigation.Test\bin\Debug" -filter:"+[CoverageInvestigation]*"
